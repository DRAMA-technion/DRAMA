...
def gen_all_traces(
        ...
        dram_config_file='./dram_configs/dram.cfg',
        net_name='test',
        layer_name='Conv'
    ):
    ...
    bridge = br.Bridge(
        dram_config_file=dram_config_file,
        ...
        file_prefix=net_name + "_" + layer_name
    )

    bridge.write_dram_traces()
    bridge.statistics(net_name=net_name,layer_name=layer_name)
