...
class scale:
    ...
    def parse_config(self):
       ...
       # config_filename = "./scale.cfg"
        ...
        self.dram_config_file = FLAGS.arch_config
    ...
    def run_once(self):
        ...
        r.run_net(  ifmap_sram_size  = int(self.isram_min),
                    ...
                    dram_config_file = self.dram_config_file
                )
        self.cleanup()
    ...
    def cleanup(self):
        ...
        cmd = "mkdir " + path + "/DRAMA_stats"
        os.system(cmd)

        cmd = "mv " + path + "/*DRAMA*.csv " + path + "/DRAMA_stats"
        os.system(cmd)

        cmd = "mv " + path +"/*sram*.csv " + path +"/layer_wise"
        os.system(cmd)

        cmd = "mv " + path +"/*dram*.csv " + path +"/layer_wise"
        os.system(cmd)
